...
class HairSpider(scrapy.Spider):
    name = 'Haircare'
    start_urls = [
        'https://www.amazon.com/s?i=specialty-aps&bbn=16225006011&rh=n%3A%2116225006011%2Cn%3A11057241&ref=nav_em__nav_desktop_sa_intl__0_2_11_4'
    ]
    ...
    def parse(self, response):
        ...
        for products in all_products:
            ...
            items['Product_Category'] = 'Haircare'
